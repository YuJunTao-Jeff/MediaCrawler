...
async def parse_cmd():
    ...
    parser.add_argument('--platform', type=str, help='Media platform select (xhs | xhs_simulation_new | tieba | tieba_simulation | dy | ks | bili | wb | zhihu | news | sogou_weixin)',
                        choices=["xhs", "xhs_simulation_new", "tieba", "tieba_simulation", "dy", "ks", "bili", "wb", "zhihu", "news", "sogou_weixin"], default=config.PLATFORM)
